...
public class BlackBoxTest implements ITest {
    ...
    public BlackBoxTest(MethodCaller methodCaller, ParametersGenerator generator, Object...parameters){
    ...
    public BlackBoxTest fuzz() throws ValueGeneratorException {
        return new BlackBoxTest(methodCaller, generator, generator.mutate(parameters));
    }
}
